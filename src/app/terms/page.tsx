...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Users may delete their account from the customer or driver Account area. MOOVU may retain trip, receipt, payment, tax, accounting, fraud-prevention, support, dispute, legal, and safety records where required while deleting or anonymizing remaining account data.",
    ],
  },
  {
